            ...
            <!--- PAGE CONTENT BEGINS --->
              ...
              <div>
                ...
                <cfif #get_Player.division_type# EQ 1>
                  ...
                  <h4><span class="text-danger"><strong>FORM</strong> ...</span></h4>

                <cfelseif #get_Player.division_type# EQ 2>

                  <h4><span class="text-danger"><strong>SPARRING</strong> ...</span></h4>

                <cfelseif #get_Player.division_type# EQ 3>

                  <h4><span class="text-danger"><strong>CREATIVE FORM</strong> ...</span></h4>

                <cfelseif #get_Player.division_type# EQ 4>

                  <h4><span class="text-danger"><strong>BREAKING</strong> ...</span></h4>

                <cfelseif #get_Player.division_type# EQ 5>

                  <h4><span class="text-danger"><strong>WEAPON</strong> ...</span></h4>
              ...
              <cfoutput query="getCode">
                ...
                <h4>PLAYER LIST </h4>
                  ...
                  <div class="well well-sm">
                    Age : <span class="blue">#division_age_group.age_group#</span> | Weight : <span class="blue">#division_weight.weight#</span> | Belt : <span class="blue">#division_belt.belt#</span>
                  </div>
