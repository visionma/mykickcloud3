        ...
        <cfif structKeyExists(session,'school_id') and trim(session.school_id) neq "">
          ...
          <div id="id-message-content">
            ...
            <div class="message-body">
              ...
              <cfform action="forum_view.cfm?vid=#getGame.num#" name="postComment">
                ...
                <cfinput type="hidden" name="name" value="#getSchool.school_name#">
                <cfinput type="hidden" name="email" value="#getSchool.school_email#">
