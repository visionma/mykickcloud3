							...
							<div class="col-xs-12 col-sm-3 center">
								<div>
									<span class="profile-picture">
										<cfif #getUser.avatar_filename# is "">
											<img id="avatar" class="editable img-responsive" src="../mcs/assets/avatars/avatar2.png" />
										<cfelse>
											<img id="avatar" class="editable img-responsive" src="../mcs/assets/avatars/#getUser.avatar_filename#" />
										</cfif>
									</span>
								...
								<div class="hr hr12 dotted"></div>
									...
									<div class="clearfix">
										...
										<a href="member_edit.cfm?uid=#getUser.members_id#" class="btn btn-app btn-primary btn-xs">
