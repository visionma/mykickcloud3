...
<cfquery name="school_user_list" datasource="mykickcloud" >
    select *
    from school_user
    where is_active = '1' and school_id = '#session.school_id#'
</cfquery>  
	...
	<table id="forum_table"  class="table table-striped table-bordered table-hover">
		<thead>
			<tr>
				...
				<th><a href="school_user_add.cfm" class="btn btn-minier btn-pink">Add New User</a></th>
			</tr>
		</thead>
		...
		<cfloop query="school_user_list">
			...
			<tr>
				...
				<td>
					<a href="school_user_edit.cfm?id=#id#" class="btn btn-minier btn-yellow">Edit</a> 
					<a href="school_user_delete.cfm?id=#id#" class="btn btn-minier">Delete</a>
				</td>
			</tr>
			</cfoutput>
		</cfloop>
...
<div>
	<p>&nbsp;</p>
I would need detail field information to finish this page.<br>
And user types.
</div>
