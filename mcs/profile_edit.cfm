...
<cfoutput query="getUser">
		...
		<cfform action="profile_edit2.cfm" class="form-horizontal" enctype="multipart/form-data" method="post">
			<div class="tabbable">
			...
			<div class="tab-content profile-edit-tab-content">
				<div id="edit-basic" class="tab-pane in active">
						...
						<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									placeholder="First" required="yes" value="#firstname#" />
									<cfinput name="middlename" class="input-small" type="text" 
									placeholder="Middle" value="#middlename#" />
									<cfinput name="lastname" class="input-small" type="text" 
									placeholder="Last" required="yes" value="#lastname#" />
								</div>
							</div>
						</div>
					</div>
					...
					<hr />
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-date">Birthdate : </label>

						<div class="col-sm-9">
							<div class="input-medium">
								<div class="input-group">
									<cfinput name="birthday" type="text" required="yes" value="#birthday#" mask="99/99/9999"/>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-weight">Weight </label>
							<div class="col-sm-9">
								<cfinput name="member_weight" type="text" required="yes" value="#member_weight#" mask="999"/> 
								<cfselect name="weight_type">
									<option value="#weight_type#" selected>#weight_type#</option>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-height">Height </label>
							<div class="col-sm-9">
								<cfinput name="member_height" type="text" required="yes" value="#member_height#" mask="9"/> 
								<cfselect name="height_type">
									<option value="#height_type#" selected>#height_type#</option>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-email">Confirm Email</label>

						<div class="col-sm-9">
							<span class="input-icon input-icon-right">
								<cfinput name="email_address2" type="email" required="yes" value="#email_address2#" />
								<i class="icon-envelope"></i>
							</span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-phone">Day Phone</label>

							<div class="col-sm-9">
								<span class="input-icon input-icon-right">
									<cfinput name="member_day_phone" 
									 type="text" value="#member_day_phone#" mask="(999) 999-9999"/>
									<i class="icon-phone icon-flip-horizontal"></i>
								</span>
							</div>
						</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<span class="input-icon input-icon-right">
										<cfinput name="member_cell_phone" 
										 type="text" value="#member_cell_phone#" mask="(999) 999-9999"/>
										<i class="icon-phone icon-flip-horizontal"></i>
									</span>
								</div>
							</div>
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<cfinput type="text" name="answer" class="col-xs-12 col-sm-4" id="answer" value="#answer#"/>
								</div>
							</div>
						</div>
		...
		<div class="clearfix form-actions center">
				<cfinput type="hidden" name="uid" value="#url.uid#">
